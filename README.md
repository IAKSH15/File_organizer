...
🔮 Future Improvements
 Add undo functionality for the last organize action
 Allow users to customize categories and extensions via a config file
 Add a progress bar for large folders
 Support recursive organizing of subfolders
 Add logging of moved files for auditing
📝 License
